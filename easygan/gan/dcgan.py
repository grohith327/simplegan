...
from ..datasets import load_cifar10, load_mnist, load_custom_data, load_cifar100, load_lsun
...
class DCGAN():
    ...
    def generator(self, params):
        ...
        model.add(Reshape(((self.image_size[0] // 4), (self.image_size[1] // 4), (gen_channels*2))))
    ...
    def discriminator(self, params):
        ...
        disc_channels = params['disc_channels'] if 'disc_channels' in params else [16, 32, 64]
