...
class CGAN:
  ...
  def load_data(self, use_mnist=True, batch_size = 32):
  ...
  def generator(self, params):
     ...
     embedded_label = layers.Embedding(
         input_dim=10, output_dim=self.noise_dim)(label)
     embedded_label = layers.Dense(units=start_image_size[0]*start_image_size[1],
                      activation=activation, kernel_initializer=kernel_initializer,
                      kernel_regularizer=kernel_regularizer, input_dim=noise_dim)(embedded_label)
